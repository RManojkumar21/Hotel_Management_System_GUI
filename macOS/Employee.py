...
def update():
    ...
    if c%2==0:
        ...
        rootsub6.configure(bg="seagreen2")
        Label(rootsub6,text="",bg="seagreen2").pack()
        Label(rootsub6,text="Enter Phone No. to update Employee Record :",bg="seagreen2",font=("mono",15)).pack()
        Label(rootsub6,text="",bg="seagreen2").pack()
        def fetch():
        ...
        phoneno=Entry(rootsub6,bd=0)
        phoneno.pack()
        Label(rootsub6,text="",bg="seagreen2",height=1).pack()
        Button(rootsub6,text="Fetch",highlightbackground="light grey",width=10,height=2,command=fetch).pack()
...
def delete():
    ...
    if k==1:
        ...
        Label(rootsub5,text="",bg="Indianred").pack()
        nam=Entry(rootsub5,bd=0)
        nam.pack()
        Label(rootsub5,text="",bg="Indianred").pack()
        Label(rootsub5,text="Contact:",bg="Indianred",font=("times new roman",15,"bold")).pack()
        Label(rootsub5,text="",bg="Indianred").pack()
        phone=Entry(rootsub5,bd=0)
        phone.pack()
        Label(rootsub5,text="",bg="Indianred").pack()
        Button(rootsub5,text="Delete",highlightbackground="light grey",width=10,height=2,command=delEmployee).place(x=95,y=250)
        def destroy():
            global rootsub5,k
            k=0
            rootsub5.destroy()
            
        Button(rootsub5,text="Quit",highlightbackground="light grey",width=10,height=2,command=destroy).place(x=205,y=250)    
...
def employee():
    ...
    if m==1:
        ...
        Label(root5,text="EMPLOYEE INFO",bg="light Grey",fg="Black",font=("ubuntu",30,"italic"),width=15).pack()
        ...
        def back():
            ...
            if a==1:
                ...
                return
        Button(root5,text="back",highlightbackground="light Grey",fg="black",width=6,height=2,command=back).place(x=900,y=630)
        #container
        Lf=Frame(root5,bg="light green",width=700,height=500)
        Lf.pack()
        ...
        #Name
        Label(Lf,text="Name :",bg="light green",fg="black",font=("times new roman",17,"bold")).place(x=10,y=20)
        name=Entry(Lf,bd=0)
        name.place(x=75,y=21)
        #Age
        Label(Lf,text="Age :",bg="light green",fg="black",font=("times new roman",17,"bold")).place(x=300,y=20)
        age=Entry(Lf,bd=0,width=5)
        age.place(x=350,y=21)
        #D.O.B
        Label(Lf,text="D.O.B :",bg="light green",fg="black",font=("times new roman",17,"bold")).place(x=450,y=20)
        dob=Entry(Lf,bd=0,width=10)
        dob.place(x=520,y=21)
    
        #Gender
        Label(Lf,text="Gender :",bg="light green",fg="black",font=("times new roman",17,"bold")).place(x=10,y=80)
        g1=Radiobutton(Lf,text="Male",bg="light green",value=1,variable=gender1,command=lambda :gen(1))
        g1.place(x=90,y=83)
        g2=Radiobutton(Lf, text="Female", bg="light green",value=2,variable=gender1,command=lambda :gen(2))
        g2.place(x=150, y=83)
        #Contact
        Label(Lf,text="Contact :",bg="light green",fg="black",font=("times new roman",17,"bold")).place(x=240,y=80)
        contact=Entry(Lf,bd=0,width=11)
        contact.place(x=320,y=83)
        #E-mail
        Label(Lf,text="E-mail :",bg="light green",fg="black",font=("times new roman",17,"bold")).place(x=430,y=80)
        mail=Entry(Lf,bd=0)
        mail.place(x=500,y=83)
    
        #Address
        Label(Lf,text="Address :",bg="light green",fg="black",font=("times new roman",17,"bold")).place(x=10,y=140)
        address=Entry(Lf,bd=0,width=28)
        address.place(x=93,y=143)
        #City
        Label(Lf,text="City :",bg="light green",fg="black",font=("times new roman",17,"bold")).place(x=360,y=140)
        city=ttk.Combobox(Lf,width=8,height=5,textvariable=cy)
        ...
        #State
        Label(Lf,text="State :",bg="light green",fg="black",font=("times new roman",17,"bold")).place(x=510,y=140)
        state=ttk.Combobox(Lf,width=10,height=5,textvariable=st)
        ...
        #Department
        Label(Lf,text="Department :",bg="light green",fg="black",font=("times new roman",17,"bold")).place(x=10,y=200)
        dep=Entry(Lf,bd=0,width=27)
        dep.place(x=120,y=202)
        #Status
        Label(Lf,text="Status :",bg="light green",fg="black",font=("times new roman",17,"bold")).place(x=420,y=200)
        s1=Radiobutton(Lf,text="active",bg="light green",value=1,variable=status1,command= lambda: status(1))
        s1.place(x=500,y=201)
        s2=Radiobutton(Lf, text="inactive", bg="light green",value=2,variable=status1,command= lambda: status(2))
        s2.place(x=580, y=201)

        #ID_Proof
        Label(Lf,text="ID-Proof :",bg="light green",fg="black",font=("times new roman",17,"bold")).place(x=10,y=260)
        checkbt1=Checkbutton(Lf,text="Aadhaar",bg="light green",variable=c1,bd=0,onvalue=1,offvalue=0,command=lambda: check(1))
        checkbt1.place(x=100,y=263)
        checkbt2=Checkbutton(Lf,text="PAN Card",bg="light green",variable=c2,onvalue=1,offvalue=0,bd=0,command=lambda: check(2))
        checkbt2.place(x=100,y=290)
        checkbt3=Checkbutton(Lf,text="Passport",bg="light green",variable=c3,onvalue=1,offvalue=0,bd=0,command=lambda: check(3))
        checkbt3.place(x=100,y=320)
        checkbt4=Checkbutton(Lf,text="Driving Lisence",bg="light green",variable=c4,onvalue=1,offvalue=0,bd=0,command=lambda: check(4))
        checkbt4.place(x=100,y=350)
        Label(Lf,text="(Any 3)",bg="light green",fg="black",font=("times new roman",14,"bold")).place(x=220,y=349)

        #Employment_type
        Label(Lf,text="Employment Type :",bg="light green",fg="black",font=("times new roman",17,"bold")).place(x=270,y=260)
        emptype=Entry(Lf,bd=0,width=24)
        emptype.place(x=430,y=262)
        #Salary
        Label(Lf,text="Salary :",bg="light green",fg="black",font=("times new roman",17,"bold")).place(x=315,y=320)
        salary=Entry(Lf,bd=0)
        salary.place(x=395,y=322)    

        #Add,Update,Delete,Reset
        Button(Lf,text="Add",highlightbackground="Blue",fg="black",width=15,height=3,command=addEmployee).place(x=58,y=420)
        Button(Lf,text="Update",highlightbackground="dark green",fg="black",width=15,height=3,command=update).place(x=205,y=420)
        Button(Lf,text="Delete",highlightbackground="red",fg="black",width=15,height=3,command=delete).place(x=352,y=420)
        Button(Lf,text="Reset",highlightbackground="orange",fg="black",width=15,height=3,command=reset).place(x=499,y=420)

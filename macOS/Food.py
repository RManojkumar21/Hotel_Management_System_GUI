...
def receipt():
    ...
    try:
        ...
        Label(rootsub,text="----------RECEIPT----------",bg="ivory2").place(relx=0.26,rely=0.04)
        ...
        Button(rootsub,text="Bill",highlightbackground="light grey",width=7,height=1,bd=0,command=bill).place(relx=0.4,rely=0.84)
...
def food():
    ...
    if c==1:
        ...
        Label(root6,text="FOOD STUFF",bg="light grey",fg="Black",font=("mono",30,"italic"),width=12).pack()
        #back
        def back():
            global c
        ...
        Button(root6,text="back",highlightbackground="light Grey",fg="black",width=6,height=2,command=back).place(x=1115,y=660)

        #container1
        Label(root6,text="",bg="coral1",width=2).pack(side=LEFT)
        Lf=Frame(root6,bg="springgreen3",width=360,height=500)
        Lf.pack(side=LEFT)
        Label(Lf,text="Fruits & Vegetables",fg="black",bg="springgreen3",font=("mono",18,"italic")).place(x=90,y=10)
        ...
        #fruits
        Label(Lf,text="Apples and Pears :",fg="black",bg="springgreen3",font=("mono",15,"italic")).place(x=20,y=90)
        qf1=Entry(Lf,bd=0,width=3)
        qf1.place(x=210,y=91)
        f1=Entry(Lf,bd=0,width=5)
        f1.place(x=280,y=91)
        Label(Lf,text="Bananas and Mangoes :",fg="black",bg="springgreen3",font=("mono",15,"italic")).place(x=20,y=150)
        qf2=Entry(Lf,bd=0,width=3)
        qf2.place(x=210,y=151)
        f2=Entry(Lf,bd=0,width=5)
        f2.place(x=280,y=151)
        Label(Lf,text="Berries and Melons :",fg="black",bg="springgreen3",font=("mono",15,"italic")).place(x=20,y=210)
        qf3=Entry(Lf,bd=0,width=3)
        qf3.place(x=210,y=211)
        f3=Entry(Lf,bd=0,width=5)
        f3.place(x=280,y=211)
        #vegetables
        Label(Lf,text="Leafy green and Root :",fg="black",bg="springgreen3",font=("mono",15,"italic")).place(x=20,y=270)
        qf4=Entry(Lf,bd=0,width=3)
        qf4.place(x=210,y=271)
        f4=Entry(Lf,bd=0,width=5)
        f4.place(x=280,y=271)
        Label(Lf,text="Cruciferous and Marrow :",fg="black",bg="springgreen3",font=("mono",15,"italic")).place(x=20,y=330)
        qf5=Entry(Lf,bd=0,width=3)
        qf5.place(x=210,y=331)
        f5=Entry(Lf,bd=0,width=5)
        f5.place(x=280,y=331)
        Label(Lf,text="Total :",fg="black",bg="springgreen3",font=("mono",15,"italic")).place(x=210,y=392)
        t=Entry(Lf,bd=0,width=5)
        t.place(x=280,y=391)
        #total
        Button(Lf,text="Total",highlightbackground="light Grey",width=10,height=2,command=lambda: total(1)).place(x=130,y=440)
        ...
        Lf1.pack(side=LEFT)
        Label(Lf1,text="Special Ingredients",fg="black",bg="tan1",font=("mono",18,"italic")).place(x=100,y=10)
        ...
        #soft-drinks
        Label(Lf1,text="Maida and Wheet Flour :",fg="black",bg="tan1",font=("mono",15,"italic")).place(x=20,y=90)
        qs1=Entry(Lf1,bd=0,width=3)
        qs1.place(x=210,y=91)
        sp1=Entry(Lf1,bd=0,width=5)
        sp1.place(x=280,y=91)
        Label(Lf1,text="Special Masala :",fg="black",bg="tan1",font=("mono",15,"italic")).place(x=20,y=150)
        qs2=Entry(Lf1,bd=0,width=3)
        qs2.place(x=210,y=151)
        sp2=Entry(Lf1,bd=0,width=5)
        sp2.place(x=280,y=151)
        Label(Lf1,text="Rice :",fg="black",bg="tan1",font=("mono",15,"italic")).place(x=20,y=210)
        qs3=Entry(Lf1,bd=0,width=3)
        qs3.place(x=210,y=211)
        sp3=Entry(Lf1,bd=0,width=5)
        sp3.place(x=280,y=211)
        #Dessert
        Label(Lf1,text="Dessert :",fg="black",bg="tan1",font=("mono",15,"italic")).place(x=20,y=270)
        qs4=Entry(Lf1,bd=0,width=3)
        qs4.place(x=210,y=271)
        sp4=Entry(Lf1,bd=0,width=5)
        sp4.place(x=280,y=271)
        Label(Lf1,text="Diary Products :",fg="black",bg="tan1",font=("mono",15,"italic")).place(x=20,y=330)
        qs5=Entry(Lf1,bd=0,width=3)
        qs5.place(x=210,y=331)
        sp5=Entry(Lf1,bd=0,width=5)
        sp5.place(x=280,y=331)
        Label(Lf1,text="Total :",fg="black",bg="tan1",font=("mono",15,"italic")).place(x=210,y=392)
        t1=Entry(Lf1,bd=0,width=5)
        t1.place(x=280,y=391)
        #total
        Button(Lf1,text="Total",highlightbackground="light Grey",width=10,height=2,command=lambda: total(2)).place(x=130,y=440)
        ...
        Lf2.pack(side=RIGHT)
        Label(Lf2,text="Non-Vegetables",fg="black",bg="Indianred3",font=("mono",18,"italic")).place(x=115,y=10)
        ...
        #Flesh
        Label(Lf2,text="Meat :",fg="black",bg="Indianred3",font=("mono",15,"italic")).place(x=85,y=90)
        qn1=Entry(Lf2,bd=0,width=3)
        qn1.place(x=210,y=91)
        nv1=Entry(Lf2,bd=0,width=5)
        nv1.place(x=280,y=91)
        Label(Lf2,text="Chicken :",fg="black",bg="Indianred3",font=("mono",15,"italic")).place(x=85,y=150)
        qn2=Entry(Lf2,bd=0,width=3)
        qn2.place(x=210,y=151)
        nv2=Entry(Lf2,bd=0,width=5)
        nv2.place(x=280,y=151)
        Label(Lf2,text="Beef :",fg="black",bg="Indianred3",font=("mono",15,"italic")).place(x=85,y=210)
        qn3=Entry(Lf2,bd=0,width=3)
        qn3.place(x=210,y=211)
        nv3=Entry(Lf2,bd=0,width=5)
        nv3.place(x=280,y=211)
        #Eggs&Fish
        Label(Lf2,text="Eggs :",fg="black",bg="Indianred3",font=("mono",15,"italic")).place(x=85,y=270)
        qn4=Entry(Lf2,bd=0,width=3)
        qn4.place(x=210,y=271)
        nv4=Entry(Lf2,bd=0,width=5)
        nv4.place(x=280,y=271)
        Label(Lf2,text="Fish :",fg="black",bg="Indianred3",font=("mono",15,"italic")).place(x=85,y=330)
        qn5=Entry(Lf2,bd=0,width=3)
        qn5.place(x=210,y=331)
        nv5=Entry(Lf2,bd=0,width=5)
        nv5.place(x=280,y=331)
        Label(Lf2,text="Total :",fg="black",bg="Indianred3",font=("mono",15,"italic")).place(x=210,y=392)
        t2=Entry(Lf2,bd=0,width=5)
        t2.place(x=280,y=391)
        #total
        Button(Lf2,text="Total",highlightbackground="light Grey",width=10,height=2,command=lambda: total(3)).place(x=130,y=440)

    
        #calculator
        Label(root6,text="calc :",bg="coral1",font=("mono",13)).place(x=1080,y=100)
        Button(root6,text="+/-",highlightbackground="coral1",command=calc.calculator).place(x=1125,y=100)

        #receipt
        Button(root6,text="RECEIPT",highlightbackground="green",height=2,width=7,command=receipt).place(x=1000,y=90)

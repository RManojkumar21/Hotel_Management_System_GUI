...
def room():
    ...
    if k==1:
        ...
        Label(root7,text="ROOM INFO",bg="light Grey",fg="Black",font=("ubuntu",20,"italic"),width=12).pack()
        ...
        Button(root7,bd=3,bg="White",width=6,fg="Black",font=("mono",8,"bold"),text="Back",command=back).place(x=910,y=650)
        #container
        Lf=Frame(root7,bg="tan3",width=750,height=500)
        Lf.pack()

        #Name
        Label(Lf,text="Name :",bg="tan3",fg="black",font=("ubuntu",13,"italic")).place(x=200,y=20)
        name=Entry(Lf,bd=2,width=24)
        name.place(x=320,y=22)

        #Phone_no.
        Label(Lf,text="Phone No :",bg="tan3",fg="black",font=("ubuntu",13,"italic")).place(x=200,y=80)
        phone=Entry(Lf,bd=2,width=24)
        phone.place(x=320,y=82)

        #Room_No.
        Label(Lf,text="Room No :",bg="tan3",fg="black",font=("ubuntu",13,"italic")).place(x=200,y=140)
        roomno=Entry(Lf,bd=2,width=24)
        roomno.place(x=320,y=142)

        #Meals
        Label(Lf,text="Meals :",bg="tan3",fg="black",font=("ubuntu",13,"italic")).place(x=200,y=200)
        meals=ttk.Combobox(Lf,width=21)
        meals["values"]=('Taken','Not Taken')
        meals["state"]='readonly'
        meals.place(x=320,y=202)

        #Room_Type
        Label(Lf,text="Room Type :",bg="tan3",fg="black",font=("ubuntu",13,"italic")).place(x=200,y=260)
        roomtype=ttk.Combobox(Lf,width=21)
        roomtype["values"]=('Single Room','Double Room','Deluxe')
        roomtype["state"]='readonly'
        roomtype.place(x=320,y=262)
        #check_in
        Label(Lf,text="Check In :",bg="tan3",fg="black",font=("ubuntu",13,"italic")).place(x=200,y=320)
        checkin=Entry(Lf,bd=2,width=23)
        checkin.place(x=320,y=322)

        #check_out
        Label(Lf,text="Check Out :",bg="tan3",fg="black",font=("ubuntu",13,"italic")).place(x=200,y=380)
        checkout=Entry(Lf,bd=2,width=23)
        checkout.place(x=320,y=382)

        #add
        Button(Lf,text="Add",width=10,height=2,bd=2,command=addRoom).place(x=300,y=440)
        #clear
        Button(Lf,text="Clear",width=10,height=2,bd=2,command=clear).place(x=390,y=440)    
        #calendar
        Button(Lf,text="-|||-",highlightbackground="tan3",command=calendar).place(x=475,y=321)
        Button(Lf,text="-|||-",highlightbackground="tan3",command=calendar1).place(x=475,y=381)    
